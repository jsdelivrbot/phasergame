...
map = {
	...
	getTile: function(x,y,l,cb,raw){ //returns tile
	...
	getTiles: function(from,to,cb,raw){ //returns map data
		from = fn.combindIn({
			x: 0,
			y: 0,
			l: 0
...
Object.defineProperty(Tile.prototype, "properties", {
    get: function () {
        return map.tileProperties[this.index] || {
        	blank: false,
        	collision: false,
        	collisionInfo: {
        		top: 0,
